package org.sobadfish.fishbasket.db;
...
//                ContentValues contentValues = new ContentValues();
     ...
     * 删除数据
     * */
    public SqliteHelper remove(String tableName,String id){
        try {
            if (statement != null) {
    ...
    public <T> SqliteHelper set(String tableName,T values){
        ...
        return set(tableName,contentValues.getString("id"),contentValues);
    }
     ...
     * 更新数据
     * */
    public SqliteHelper set(String tableName, String id, SqlData values){
        try {
            if(statement != null) {
...
//        return  set(tableName,key,value,sqlData);
    ...
    public <T> T get(String tableName,String id, Class<T> clazz){
        T instance = null;
        try {
